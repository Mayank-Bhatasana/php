            ...
            <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade"
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">WAP to check whether the number is prime or
                            not using recursion.</h2>
                        <p class="animate__animated animate__fadeInUp">
                            ...
                            $ans = is_prime(10);
                            echo "The numebr is " . ($ans ? "prime" : "not prime");
                            ?>
                        </p>
