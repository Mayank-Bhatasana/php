            ...
            <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade"
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">WAP to take two values as an input from the
                            user and display all the prime numbers between the
                            two given numbers using function.</h2>
