            ...
            <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade"
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">WAP to find maximum number from given three
                            numbers using user defined function.</h2>
