                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">
                            WAP to accept a number and check whether the number is prime or not. Use user defined
                            function name as check (int n). The method returns 1, if the number is prime otherwise, it
                            returns
                            0.</h2>
