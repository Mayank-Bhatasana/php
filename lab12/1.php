            ...
            <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade"
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">WAP that calculates area of circle, triangle
                            and square using user defined function.</h2>
                        <p class="animate__animated animate__fadeInUp">
                            ...
                            echo areaTri(10, 10) . "<br/>";

                            echo areaSquare(10) . "<br/>";
                            ?></p>
