            ...
            <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade"
                ...
                <div class="carousel-item active">
                    <div class="carousel-container">
                        <h2 class="animate__animated animate__fadeInDown">WAP to create user define function for adding
                            two numbers and display the result</h2>
                        <p class="animate__animated animate__fadeInUp">
                            ...
                            echo 'The sum is ' . addTwoNumbers(10, 10)
                            ?></p>
